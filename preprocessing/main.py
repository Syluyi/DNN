...
# glob_file_pattern = "fn00????"
# dest_file_name = "fb_fnALL"
# glob_file_pattern = "fn00???[2,8]"
# dest_file_name = "fb_fn00xxx2o8"
# glob_file_pattern = "fn00??2?"
# dest_file_name = "fb_fn00xx2x"
# glob_file_pattern = "fn00153?"
# dest_file_name = "fb_fn00153x"
glob_file_pattern = "fn001105"
dest_file_name = "fb_fn001105"
...
dest_name = base_path + "/fb_prepared/" + dest_file_name 
if (use_deltas):
...
[mfcc,labels]=proc_data(pattern,f_ex,params,glob_annot_path,glob_wav_path,conv_table,CGN)
